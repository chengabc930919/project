...
function des(key, message, encrypt, mode, iv, padding) {
  ...
  var m = 0; var i; var j; var temp; var temp2; var right1; var right2; var left; var right; var looping
  ...
  if (!encrypt) { // 如果是解密的话，解密结束后对PKCS7 padding进行解码，并转换成utf-8编码
    if (padding === 1) { // PKCS7 padding解码
      var len = result.length; var paddingChars = 0
...
function des_createKeys(key) {
  ...
  // other variables
  var lefttemp; var righttemp; var m = 0; var n = 0; var temp
